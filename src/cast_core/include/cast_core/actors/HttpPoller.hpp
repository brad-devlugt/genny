...
#ifndef HEADER_68E29D9A_9A13_4BDA_A652_49A7036804A8_INCLUDED
#define HEADER_68E29D9A_9A13_4BDA_A652_49A7036804A8_INCLUDED
 ...
 * ```
 *
 * Or you can fill out the generated workloads/docs/HttpPoller.yml
 * file with extended documentation. If you do this, please mention
 * that extended documentation can be found in the docs/HttpPoller.yml
 * file.
 *
 * Owner: TODO (which github team owns this Actor?)
 */
class HttpPoller : public Actor {
    ...
    // of the work is in the associated `HttpPoller.cpp` file and its
    // assocated `HttpPoller_test.cpp` integration-test file.
    //
...
public:
    ...
    // .cpp file.
    //
    explicit HttpPoller(ActorContext& context);
    ~HttpPoller() = default;
    ...
    //
    // This is how Genny knows that `Type: HttpPoller` in workload YAMLs
...
private:
    ...
    // `HttpPoller.cpp` implementation file.
    //
...
#endif  // HEADER_68E29D9A_9A13_4BDA_A652_49A7036804A8_INCLUDED
